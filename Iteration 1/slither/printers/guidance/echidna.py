    ...
    for ir in irs:
        ...
        if (
            ...
            try:
                ...
                cst_not_used.append(ConstantValue(str(internal_num), "uint256"))
            except ValueError:  # index could fail; should never happen in working solidity code
                pass

        # else if(isinstance(ir,Member)):
        #     internal_num = ir.variable_left.values.index(ir.variable_right.value)
...
def detect_defined_constant(contracts):
    # defined_constant={}
    # ret_cst_not_used={}
    # for contract in contracts:
    #     for variable in contract.state_variables:
    #         if isinstance(variable,Constant):
    #             defined_constant.append(variable.name)
...
def _extract_constants(
    ...
    ret_cst_not_used: Dict[str, Dict[str, List[ConstantValue]]] = defaultdict(dict)
    ...
    ret_cst_not_used=detect_defined_constant(contracts) #rk
        
    #  ret_cst_not_used = all_cst_used - ret_cst_used   
    return ret_cst_used, ret_cst_used_in_binary,ret_cst_not_used 
...
class Echidna(AbstractPrinter):
    ...
    def output(self, filename: str) -> Output:  # pylint: disable=too-many-locals
        ...
        (cst_used, cst_used_in_binary,ret_cst_not_used) = _extract_constants(contracts) #rk
        ...
        d = {
            ...
            "constant_not_used": ret_cst_not_used,
